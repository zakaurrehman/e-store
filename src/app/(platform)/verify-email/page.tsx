...
async function VerifyContent({ searchParams }: PageProps<"/verify-email">) {
    ...
    return (
      <AuthShell title="We couldn't confirm your email" description={message}>
        ...
        <ButtonLink href="/dashboard" fullWidth size="lg">
          Go to your dashboard to resend
        </ButtonLink>
      </AuthShell>
    );
  }
  return (
    <AuthShell title="Email confirmed" description="Thanks — your email address is confirmed. Your store will now receive order and account emails.">
