 ...
 */
async function SandboxContent({ params, searchParams }: PageProps<"/s/[store]/checkout/sandbox/[paymentId]">) {
...
export default function SandboxPage(props: PageProps<"/s/[store]/checkout/sandbox/[paymentId]">) {
  return (
