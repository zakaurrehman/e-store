...
async function ResetContent({ searchParams }: PageProps<"/s/[store]/reset-password">) {
...
export default function ResetPasswordPage(props: PageProps<"/s/[store]/reset-password">) {
  return (
