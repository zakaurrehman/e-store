...
export async function generateMetadata({ params }: PageProps<"/s/[store]/collections/[slug]">): Promise<Metadata> {
...
async function CollectionContent({ params, searchParams }: PageProps<"/s/[store]/collections/[slug]">) {
...
export default function CollectionPage(props: PageProps<"/s/[store]/collections/[slug]">) {
  return (
