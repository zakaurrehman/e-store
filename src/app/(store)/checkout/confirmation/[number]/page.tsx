...
async function ConfirmationContent({ params, searchParams }: PageProps<"/checkout/confirmation/[number]">) {
...
export default function ConfirmationPage(props: PageProps<"/checkout/confirmation/[number]">) {
  return (
